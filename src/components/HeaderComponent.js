        ...
        <Navbar dark expand="md">
          <div className="container">
            ...
            <Collapse isOpen={this.state.isNavOpen} navbar>
              <Nav navbar>
                <NavItem>
                  <NavLink className="nav-link" to="/home" active>
              ...
              <Nav className="ml-auto" navbar>
                <NavItem>
                  <Button onClick={this.toggleModal} color="primary"><span className="fa fa-sign-in fa-lg"></span> Login</Button>
                </NavItem>
              </Nav>
            </Collapse>
          </div>
          ...
          <ModalBody>
            <Form onSubmit={this.handleLogin}>
              ...
              <FormGroup>
                ...
                <Input type="paasword" to="password" name="password"
